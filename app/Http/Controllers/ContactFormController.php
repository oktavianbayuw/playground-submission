...
class ContactFormController extends Controller
{
    ...
    public function store(\App\Http\Requests\ContactForm\Store $request)
    {
        ...
        \Illuminate\Support\Facades\Mail::to('testing@laravolt.dev')->send(new SendMail());
        return redirect('contact-form')->withSuccess('Pesan telah diterima dan menunggu tindak lanjut.');
    }
